...
longTimeStep = Fraction(1,12)    #distinct time-step sizes improve effiency
shortTimeStep = Fraction(1,360)
...
# Returns a Poisson-distributed random number.
    if lambd<0: raise ValueError, "The poisson parameter must be nonnegative."
    lambd=float(lambd)
    k = 0
    p = random()
